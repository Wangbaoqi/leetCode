import { ListNode, partition_linkList, partition_linkList1 } from './index';
...
describe('test partition_linkList', () => {
  it('test_partition_link_list_mid', () => {
    ...
    const expected = new ListNode(
      1,
      new ListNode(3, new ListNode(2, new ListNode(4, new ListNode(5))))
    );
  ...
  it('test_partition_link_list_left', () => {
    ...
    const expected = new ListNode(
      1,
      new ListNode(3, new ListNode(2, new ListNode(5, new ListNode(4))))
    );
