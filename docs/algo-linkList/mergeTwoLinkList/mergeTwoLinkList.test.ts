import { ListNode, mergeTwoLists } from './21.合并两个有序链表';
...
describe('test mergeTwoLists', () => { 
  ...
  it('test_two_lists_normal', () => { 
    ...
    const list2 = new ListNode(2, new ListNode(4, new ListNode(6, new ListNode(8))));
  ...
  it('test_one_case_empty_and_one_non_empty', () => { 
    const list1 = null;
    const list2 = new ListNode(2, new ListNode(4, new ListNode(6, new ListNode(8))));
    const result = new ListNode(2, new ListNode(4, new ListNode(6, new ListNode(8))));
    expect(mergeTwoLists(list1, list2)).toEqual(result);
  })
